...
int main() {
    ...
    objs = {
        ...
        Object(glm::vec3(-2500*std::sin(120), -2500, 0), glm::vec3(0, 0, 250), 7.34767309*pow(10, 22), 3344),
        Object(glm::vec3(2500*std::sin(120), -2500, 0), glm::vec3(0, 0, 250), 7.34767309*pow(10, 22), 3344),
        Object(glm::vec3(-2500*std::sin(120), 2500, 0), glm::vec3(0, 0, 250), 7.34767309*pow(10, 22), 3344),
        // Object(glm::vec3(1500, 0, 50), glm::vec3(0, 0, 0), 5.97219*pow(10, 22)),
        // Object(glm::vec3(100, 0, 200), glm::vec3(0, 0, 0), 5.97219*pow(10, 22)),
...
GLFWwindow* StartGLU() {
    ...
    GLFWwindow* window = glfwCreateWindow(1400, 1400, "3D_TEST", NULL, NULL);
    if (!window) {
